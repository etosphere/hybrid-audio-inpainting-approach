...
![parabola-shape](./paper/figures/amplitude-parabola-partial-birth.pdf)
...
\end{equation}
$$
where $a_{\mathrm{R}}$ is the first reliable amplitude after the gap, $\beta_{\mathrm{trend}}$ is the slope of linear trend, and $l_{\mathrm{birth}}$ is the length of the partial birth.
